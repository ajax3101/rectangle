...
class QuizCreateView(CreateView):
    ...
    def form_valid(self, form):
        ...
        quiz.save()
        messages.success(self.request, 'Опросник был создан успешно! Идите и добавьте несколько вопросов сейчас')
...
class QuizDeleteView(DeleteView):
    ...
    def delete(self, request, *args, **kwargs):
        ...
        messages.success(request, 'Опросник %s был успешно удален!' % quiz.name)
...
def question_add(request, pk):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            question.quiz = quiz
            question.save()
            messages.success(request, 'Теперь вы можете добавить ответы / варианты на вопрос.')
    ...
    if request.method == 'POST':
        ...
        if form.is_valid() and formset.is_valid():
            with transaction.atomic():
                form.save()
                formset.save()
            messages.success(request, 'Вопрос и ответы сохранены успешно!')
            return redirect('teachers:quiz_change', quiz.pk)
    else:
...
class QuestionDeleteView(DeleteView):
    ...
    def delete(self, request, *args, **kwargs):
        question = self.get_object()
        messages.success(request, 'Вопрос %s был успешно удален!' % question.text)
        return super().delete(request, *args, **kwargs)
